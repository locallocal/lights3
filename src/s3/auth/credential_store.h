// L2: dynamic credential management (docs/credential-management.md): AK/SK generation/lookup/revocation +
...
public:
    ...
    // random space tenant/tenant_admin: tenancy attributes (docs/multi-tenancy.md §4); the tenant id is validated by
    // the caller against the tenant registry
