...
// (docs/architecture/storage/duostore-design.md §3.1). meta stores/loads DataRef as opaque location
...
struct Extent {
    // kRados: file_id maps to the rados object name (docs/architecture/storage/duostore-data-rados-design.md §3.1)
...
// Per-call batch cap for alloc_file_run: writers grow
