...
public:
    ...
    // the scheduling thread that determines expiry: request_cancel
    ...
    // never-firing" id is a debugging trap; cancel(0) is always a
...
private:
    ...
    // Callback duration observability; atomic storage, so stats()
