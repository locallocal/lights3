// Iceberg manifest-list / manifest records (docs/s3-tables/step-3-validation-diagnostics.md
// §4): the fields the deep snapshot check needs, lifted from the Avro JSON the reader
