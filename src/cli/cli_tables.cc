...
// The catalog store the configuration names (docs/architecture/s3-tables-design.md §12): the
...
Cmd make_tables() {
    auto cmd = make_group("tables", "lights3 tables export catalog.jsonl --config=config/lights3.yaml",
                          ...
                          "docs/architecture/s3-tables-design.md §12): export writes every catalog object of every "
