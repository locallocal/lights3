    ...
    for (char c : s) {
        switch (c) {
            ...
            default:
                ...
                // drop them outright, an output-side safety net against reflection (<Resource> echoes request-side
                // strings; beyond upstream validation, output must always remain valid
                // XML)
