// L3: Ceph/RADOS implementation of IDataStore (docs/architecture/storage/duostore-data-rados-design.md).
...
struct RadosDataOptions {
    ...
    // Write-side pins: pin upon allocating a file_id, unpin on
...
public:
    ...
    // (IMetaStore::alloc_file_run, only contiguous ids make the
