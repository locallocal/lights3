...
| [s3-tables-design.md](s3-tables-design.md) | S3 Tables / Apache Iceberg REST Catalog（①–⑤ 已实现，2026-09-12）：RustFS 实现调研结论、建在 `.sys` 上的目录状态与 `PutCondition` CAS 提交协议、REST 端点与错误模型、Avro 深校验与诊断/恢复、表桶守卫与凭证下发、维护作业与 `lights3-ctl tables`、多网关矩阵、PyIceberg / DuckDB 冒烟 |
