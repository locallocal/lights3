...
// The L3 storage layer also throws S3Error (convention in docs/storage/storage-backend.md §1), so this header has no HTTP model dependency.
#pragma once
...
// wire code -> enum reverse lookup (used by cloudproxy to pass through remote errors, docs/storage/cloudproxy-design.md §5.1); returns nullopt for unknown codes
