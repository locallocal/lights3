...
| S3 Tables（Iceberg REST Catalog） | 设计稿 [s3-tables-design.md](s3-tables-design.md)、实施文档 [s3-tables/](s3-tables/README.md)；**① 已实现（2026-09-12）**：`/iceberg/v1` 目录、表桶、提交协议、守卫、单测与 e2e 段。下一步 ②（policy 三元组已在 ① 落地，剩租户门、`s3tables` 签名名、凭证下发、lifecycle 排除）→ ③ Avro 深校验与诊断 → ④ 维护 |
