...
public:
    ...
    httplib::Result get_hashed(const std::string& path, const std::string& query, std::string* md5_hex,
                               uint64_t* bytes);
    ...
    httplib::Result put_unsigned(const std::string& path, const std::string& body, const std::string& query = "");
    ...
    httplib::Result put_json(const std::string& path, const std::string& body, const std::string& query = "");
...
private:
    ...
    httplib::Headers sign(const std::string& method, const std::string& raw_path, const std::string& raw_query,
