...
public:
    ...
    // Bucket upper bounds (seconds) for Prometheus rendering; last bucket is +Inf
    ...
    struct ScheduleAwaiter {
        ...
        // cancellation without modification
        template <class P>
...
private:
    ...
    size_t capacity_;
    // Lock-free per-task accounting (completed_ taking a lock per
